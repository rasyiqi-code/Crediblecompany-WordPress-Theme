...
<main class="app-main-content">
    <div class="app-header-bar">
        ...
        <div class="app-page-title" style="font-size: 1.1rem; font-weight: 600; text-align: center; color: var(--text-dark); margin: 0; padding: 0 10px;"><?php esc_html_e( 'Halaman Tidak Ditemukan', 'cc' ); ?></div>
    </div>
