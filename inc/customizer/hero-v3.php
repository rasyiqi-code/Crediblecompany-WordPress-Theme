...
$wp_customize->add_control( 'cc_hero_v3_btn1_enable', array( 'label' => __( 'V3: Tampilkan Tombol Utama (Outline)', 'crediblecompany' ), 'section' => 'cc_hero_section', 'type' => 'checkbox' ) );

$wp_customize->add_setting( 'cc_hero_v3_btn1_text', array( 'default' => 'Start Trial', 'sanitize_callback' => 'sanitize_text_field' ) );
$wp_customize->add_control( 'cc_hero_v3_btn1_text', array( 'label' => __( 'V3: Teks Tombol Utama', 'crediblecompany' ), 'section' => 'cc_hero_section', 'type' => 'text' ) );

$wp_customize->add_setting( 'cc_hero_v3_btn1_url', array( 'default' => '#daftar', 'sanitize_callback' => 'esc_url_raw' ) );
$wp_customize->add_control( 'cc_hero_v3_btn1_url', array( 'label' => __( 'V3: URL Tombol Utama', 'crediblecompany' ), 'section' => 'cc_hero_section', 'type' => 'url' ) );

$wp_customize->add_setting( 'cc_hero_v3_btn1_bg_color', array( 'default' => 'transparent', 'sanitize_callback' => 'sanitize_hex_color' ) );
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v3_btn1_bg_color', array( 'label' => 'V3: Warna Latar Tombol Utama', 'section' => 'cc_hero_section' ) ) );

$wp_customize->add_setting( 'cc_hero_v3_btn1_text_color', array( 'default' => '#0f172a', 'sanitize_callback' => 'sanitize_hex_color' ) );
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v3_btn1_text_color', array( 'label' => 'V3: Warna Teks/Border Tombol Utama', 'section' => 'cc_hero_section' ) ) );

$wp_customize->add_setting( 'cc_hero_v3_btn2_enable', array( 'default' => true, 'sanitize_callback' => 'wp_validate_boolean' ) );
$wp_customize->add_control( 'cc_hero_v3_btn2_enable', array( 'label' => __( 'V3: Tampilkan Tombol Sekunder (Solid)', 'crediblecompany' ), 'section' => 'cc_hero_section', 'type' => 'checkbox' ) );

$wp_customize->add_setting( 'cc_hero_v3_btn2_text', array( 'default' => 'How It Works', 'sanitize_callback' => 'sanitize_text_field' ) );
$wp_customize->add_control( 'cc_hero_v3_btn2_text', array( 'label' => __( 'V3: Teks Tombol Sekunder', 'crediblecompany' ), 'section' => 'cc_hero_section', 'type' => 'text' ) );

$wp_customize->add_setting( 'cc_hero_v3_btn2_url', array( 'default' => '#how-it-works', 'sanitize_callback' => 'esc_url_raw' ) );
$wp_customize->add_control( 'cc_hero_v3_btn2_url', array( 'label' => __( 'V3: URL Tombol Sekunder', 'crediblecompany' ), 'section' => 'cc_hero_section', 'type' => 'url' ) );

$wp_customize->add_setting( 'cc_hero_v3_btn2_bg_color', array( 'default' => '#ff4f38', 'sanitize_callback' => 'sanitize_hex_color' ) );
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v3_btn2_bg_color', array( 'label' => 'V3: Warna Latar Tombol Sekunder', 'section' => 'cc_hero_section' ) ) );

$wp_customize->add_setting( 'cc_hero_v3_btn2_text_color', array( 'default' => '#ffffff', 'sanitize_callback' => 'sanitize_hex_color' ) );
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v3_btn2_text_color', array( 'label' => 'V3: Warna Teks Tombol Sekunder', 'section' => 'cc_hero_section' ) ) );
...
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v3_canvas_bg', array( 'label' => 'V3: Warna Canvas Grid Utama', 'section' => 'cc_hero_section' ) ) );

$wp_customize->add_setting( 'cc_hero_v3_triangle_color', array( 'default' => '#f472b6', 'sanitize_callback' => 'sanitize_hex_color' ) );
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v3_triangle_color', array( 'label' => 'V3: Warna Segitiga Melayang', 'section' => 'cc_hero_section' ) ) );

$wp_customize->add_setting( 'cc_hero_v3_card_right_bg', array( 'default' => '#0b1c3f', 'sanitize_callback' => 'sanitize_hex_color' ) );
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v3_card_right_bg', array( 'label' => 'V3: Warna Latar Kartu Kanan', 'section' => 'cc_hero_section' ) ) );

$wp_customize->add_setting( 'cc_hero_v3_circle_color', array( 'default' => '#047857', 'sanitize_callback' => 'sanitize_hex_color' ) );
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v3_circle_color', array( 'label' => 'V3: Warna Aksen Lingkaran', 'section' => 'cc_hero_section' ) ) );

$wp_customize->add_setting( 'cc_hero_v3_blue_bars_color', array( 'default' => '#3b82f6', 'sanitize_callback' => 'sanitize_hex_color' ) );
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v3_blue_bars_color', array( 'label' => 'V3: Warna Garis Biru Miring', 'section' => 'cc_hero_section' ) ) );
