...
// Callback aktif untuk V2
$v2_active_callback = function() {
    return get_theme_mod( 'cc_hero_variant', 'default' ) === 'v2';
};
...
$wp_customize->add_control( 'cc_hero_v2_padding_top_px', array(
    ...
    'active_callback' => $v2_active_callback,
) );
...
$wp_customize->add_control( 'cc_hero_v2_btn1_enable', array(
    'label'           => __( 'V2: Tampilkan Tombol Utama', 'crediblecompany' ),
    'section'         => 'cc_hero_section',
    'type'            => 'checkbox',
    'active_callback' => $v2_active_callback,
) );
...
$wp_customize->add_control( 'cc_hero_v2_btn1_text', array(
    'label'           => __( 'V2: Teks Tombol Utama', 'crediblecompany' ),
    'section'         => 'cc_hero_section',
    'type'            => 'text',
    'active_callback' => $v2_active_callback,
) );
...
$wp_customize->add_control( 'cc_hero_v2_btn1_url', array(
    'label'           => __( 'V2: URL Tombol Utama', 'crediblecompany' ),
    'section'         => 'cc_hero_section',
    'type'            => 'url',
    'active_callback' => $v2_active_callback,
) );
...
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v2_btn1_bg_color', array(
    'label'           => 'V2: Warna Latar Tombol Utama',
    'section'         => 'cc_hero_section',
    'active_callback' => $v2_active_callback,
) ) );

$wp_customize->add_setting( 'cc_hero_v2_btn1_text_color', array( 'default' => '#ffffff', 'sanitize_callback' => 'sanitize_hex_color' ) );
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v2_btn1_text_color', array(
    'label'           => 'V2: Warna Teks Tombol Utama',
    'section'         => 'cc_hero_section',
    'active_callback' => $v2_active_callback,
) ) );

$wp_customize->add_setting( 'cc_hero_v2_btn2_enable', array( 'default' => true, 'sanitize_callback' => 'wp_validate_boolean' ) );
$wp_customize->add_control( 'cc_hero_v2_btn2_enable', array(
    'label'           => __( 'V2: Tampilkan Tombol Sekunder', 'crediblecompany' ),
    'section'         => 'cc_hero_section',
    'type'            => 'checkbox',
    'active_callback' => $v2_active_callback,
) );
...
$wp_customize->add_control( 'cc_hero_v2_btn2_text', array(
    'label'           => __( 'V2: Teks Tombol Sekunder', 'crediblecompany' ),
    'section'         => 'cc_hero_section',
    'type'            => 'text',
    'active_callback' => $v2_active_callback,
) );
...
$wp_customize->add_control( 'cc_hero_v2_btn2_url', array(
    'label'           => __( 'V2: URL Tombol Sekunder', 'crediblecompany' ),
    'section'         => 'cc_hero_section',
    'type'            => 'url',
    'active_callback' => $v2_active_callback,
) );
...
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v2_btn2_bg_color', array(
    'label'           => 'V2: Warna Latar Tombol Sekunder',
    'section'         => 'cc_hero_section',
    'active_callback' => $v2_active_callback,
) ) );

$wp_customize->add_setting( 'cc_hero_v2_btn2_text_color', array( 'default' => '#1d4ed8', 'sanitize_callback' => 'sanitize_hex_color' ) );
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v2_btn2_text_color', array(
    'label'           => 'V2: Warna Teks Tombol Sekunder',
    'section'         => 'cc_hero_section',
    'active_callback' => $v2_active_callback,
) ) );
...
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v2_glow_color_1', array(
    'label'           => 'V2: Warna Ambient Glow 1 (Kiri Atas)',
    'section'         => 'cc_hero_section',
    'active_callback' => $v2_active_callback,
) ) );

$wp_customize->add_setting( 'cc_hero_v2_glow_color_2', array( 'default' => '#8B5CF6', 'sanitize_callback' => 'sanitize_hex_color' ) );
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v2_glow_color_2', array(
    'label'           => 'V2: Warna Ambient Glow 2 (Kanan Bawah)',
    'section'         => 'cc_hero_section',
    'active_callback' => $v2_active_callback,
) ) );

$wp_customize->add_setting( 'cc_hero_v2_shape_red_color', array( 'default' => '#EF4444', 'sanitize_callback' => 'sanitize_hex_color' ) );
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v2_shape_red_color', array(
    'label'           => 'V2: Warna Latar Ornamen Kiri 1',
    'section'         => 'cc_hero_section',
    'active_callback' => $v2_active_callback,
) ) );

$wp_customize->add_setting( 'cc_hero_v2_shape_purple_color', array( 'default' => '#8B5CF6', 'sanitize_callback' => 'sanitize_hex_color' ) );
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v2_shape_purple_color', array(
    'label'           => 'V2: Warna Latar Ornamen Kanan 1',
    'section'         => 'cc_hero_section',
    'active_callback' => $v2_active_callback,
) ) );

$wp_customize->add_setting( 'cc_hero_v2_shape_yellow_color', array( 'default' => '#EAB308', 'sanitize_callback' => 'sanitize_hex_color' ) );
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v2_shape_yellow_color', array(
    'label'           => 'V2: Warna Bulat Kecil Kuning',
    'section'         => 'cc_hero_section',
    'active_callback' => $v2_active_callback,
) ) );

$wp_customize->add_setting( 'cc_hero_v2_shape_blue_color', array( 'default' => '#3B82F6', 'sanitize_callback' => 'sanitize_hex_color' ) );
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v2_shape_blue_color', array(
    'label'           => 'V2: Warna Bulat Kecil Biru',
    'section'         => 'cc_hero_section',
    'active_callback' => $v2_active_callback,
) ) );
...
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v2_stat_number_color', array(
    'label'           => 'V2: Warna Angka Statistik',
    'section'         => 'cc_hero_section',
    'active_callback' => $v2_active_callback,
) ) );

$wp_customize->add_setting( 'cc_hero_v2_stat_label_color', array( 'default' => '#64748b', 'sanitize_callback' => 'sanitize_hex_color' ) );
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v2_stat_label_color', array(
    'label'           => 'V2: Warna Label Statistik',
    'section'         => 'cc_hero_section',
    'active_callback' => $v2_active_callback,
) ) );
