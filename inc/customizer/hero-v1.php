...
// Fungsi helper untuk pilihan emoji/ikon
$emoji_choices = array(
    '📚' => '📚 Buku (Edukasi)',
...
$wp_customize->add_control( 'cc_hero_v1_btn1_enable', array( 'label' => __( 'V1: Tampilkan Tombol Utama', 'crediblecompany' ), 'section' => 'cc_hero_section', 'type' => 'checkbox' ) );

$wp_customize->add_setting( 'cc_hero_v1_btn1_text', array( 'default' => 'Start Trial', 'sanitize_callback' => 'sanitize_text_field' ) );
$wp_customize->add_control( 'cc_hero_v1_btn1_text', array( 'label' => __( 'V1: Teks Tombol Utama', 'crediblecompany' ), 'section' => 'cc_hero_section', 'type' => 'text' ) );

$wp_customize->add_setting( 'cc_hero_v1_btn1_url', array( 'default' => '#daftar', 'sanitize_callback' => 'esc_url_raw' ) );
$wp_customize->add_control( 'cc_hero_v1_btn1_url', array( 'label' => __( 'V1: URL Tombol Utama', 'crediblecompany' ), 'section' => 'cc_hero_section', 'type' => 'url' ) );

$wp_customize->add_setting( 'cc_hero_v1_btn1_bg_color', array( 'default' => '#1d4ed8', 'sanitize_callback' => 'sanitize_hex_color' ) );
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v1_btn1_bg_color', array( 'label' => 'V1: Warna Latar Tombol Utama', 'section' => 'cc_hero_section' ) ) );

$wp_customize->add_setting( 'cc_hero_v1_btn1_text_color', array( 'default' => '#ffffff', 'sanitize_callback' => 'sanitize_hex_color' ) );
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v1_btn1_text_color', array( 'label' => 'V1: Warna Teks Tombol Utama', 'section' => 'cc_hero_section' ) ) );

$wp_customize->add_setting( 'cc_hero_v1_btn2_enable', array( 'default' => true, 'sanitize_callback' => 'wp_validate_boolean' ) );
$wp_customize->add_control( 'cc_hero_v1_btn2_enable', array( 'label' => __( 'V1: Tampilkan Tombol Sekunder', 'crediblecompany' ), 'section' => 'cc_hero_section', 'type' => 'checkbox' ) );

$wp_customize->add_setting( 'cc_hero_v1_btn2_text', array( 'default' => 'How It Works', 'sanitize_callback' => 'sanitize_text_field' ) );
$wp_customize->add_control( 'cc_hero_v1_btn2_text', array( 'label' => __( 'V1: Teks Tombol Sekunder', 'crediblecompany' ), 'section' => 'cc_hero_section', 'type' => 'text' ) );

$wp_customize->add_setting( 'cc_hero_v1_btn2_url', array( 'default' => '#how-it-works', 'sanitize_callback' => 'esc_url_raw' ) );
$wp_customize->add_control( 'cc_hero_v1_btn2_url', array( 'label' => __( 'V1: URL Tombol Sekunder', 'crediblecompany' ), 'section' => 'cc_hero_section', 'type' => 'url' ) );

$wp_customize->add_setting( 'cc_hero_v1_btn2_bg_color', array( 'default' => 'transparent', 'sanitize_callback' => 'sanitize_hex_color' ) );
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v1_btn2_bg_color', array( 'label' => 'V1: Warna Latar Tombol Sekunder', 'section' => 'cc_hero_section' ) ) );

$wp_customize->add_setting( 'cc_hero_v1_btn2_text_color', array( 'default' => '#1d4ed8', 'sanitize_callback' => 'sanitize_hex_color' ) );
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v1_btn2_text_color', array( 'label' => 'V1: Warna Teks Tombol Sekunder', 'section' => 'cc_hero_section' ) ) );
...
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v1_shape_main_color', array( 'label' => 'V1: Warna Latar Lingkaran Utama', 'section' => 'cc_hero_section' ) ) );

$wp_customize->add_setting( 'cc_hero_v1_shape_yellow_color', array( 'default' => '#EAB308', 'sanitize_callback' => 'sanitize_hex_color' ) );
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v1_shape_yellow_color', array( 'label' => 'V1: Warna Shape Blob Kuning', 'section' => 'cc_hero_section' ) ) );

$wp_customize->add_setting( 'cc_hero_v1_shape_blue_color', array( 'default' => '#3B82F6', 'sanitize_callback' => 'sanitize_hex_color' ) );
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v1_shape_blue_color', array( 'label' => 'V1: Warna Shape Lingkaran Biru', 'section' => 'cc_hero_section' ) ) );

$wp_customize->add_setting( 'cc_hero_v1_shape_red_color', array( 'default' => '#EF4444', 'sanitize_callback' => 'sanitize_hex_color' ) );
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v1_shape_red_color', array( 'label' => 'V1: Warna Shape Lingkaran Merah', 'section' => 'cc_hero_section' ) ) );

$wp_customize->add_setting( 'cc_hero_v1_shape_purple_color', array( 'default' => '#8B5CF6', 'sanitize_callback' => 'sanitize_hex_color' ) );
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v1_shape_purple_color', array( 'label' => 'V1: Warna Shape Lingkaran Ungu', 'section' => 'cc_hero_section' ) ) );
...
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v1_stat_number_color', array( 'label' => 'V1: Warna Angka Statistik', 'section' => 'cc_hero_section' ) ) );

$wp_customize->add_setting( 'cc_hero_v1_stat_label_color', array( 'default' => '#1e293b', 'sanitize_callback' => 'sanitize_hex_color' ) );
$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cc_hero_v1_stat_label_color', array( 'label' => 'V1: Warna Label Statistik', 'section' => 'cc_hero_section' ) ) );
